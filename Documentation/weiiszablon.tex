...
Przy założeniu że każdy neuron realizuje tą samą funkcję aktywacji, działanie sieci jednowartwowej możemy wyrazić w postaci macierzowej:
\begin{equation}
...
W związku z powyższym, należy znaleźć taką metodę, która pozwoli na minimalizację wartości funkcji $E(w, b, x)$ oraz $C(w,b)$.
